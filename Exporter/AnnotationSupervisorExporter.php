...
namespace Xterr\SupervisorBundle\Exporter;

use Xterr\SupervisorBundle\Contracts\Exporter\IAnnotationSupervisorExporter;
use Xterr\SupervisorBundle\Annotation\Supervisor as SupervisorAnnotation;
...
class AnnotationSupervisorExporter implements IAnnotationSupervisorExporter
{
    private $reader;
    private $config;
